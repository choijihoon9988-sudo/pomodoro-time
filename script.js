...
// ✅ 수정됨: 404 오류를 해결하기 위해 올바른 CDN URL로 변경 (`chart.mjs` -> `chartjs-chart-sankey.mjs`)
import { SankeyController, Flow } from 'https://cdn.jsdelivr.net/npm/chartjs-chart-sankey@0.12.1/dist/chartjs-chart-sankey.mjs';
